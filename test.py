...
if __name__ == "__main__":
    ...
    train_iter, test_iter = load_data("cifar100", batch_size=128)
    train_classifier(net, train_iter, test_iter, num_epochs=200, lr=0.1, device=try_gpu(), model_name="./models/classifiers/resnet50_cifar100.pth")
